...
import { Alert, Card, CardContent, FormControl, FormHelperText, FormLabel, InputAdornment, TextField, Typography } from '@mui/material';
          ...
          <React.Fragment>
            <CardContent>
                ...
                {warning ? <Alert severity="warning">{helperText}</Alert> : null}
                    <br/>
                    <br/>
                <Typography className="text-center" variant='h4'>Form Script Creation</Typography>
            ...
            <Box sx={{ margin : "6%"}} component="form" onSubmit={handleSubmit}>
                <FormControl fullWidth variant='outlined'>
                            ...
                            />
                            <FormHelperText id="teacher-create-form-script-code-helper">Create a Form Code and share with students if nothing entered it's value will be zero</FormHelperText>
                        </FormControl>
                <br />
                <br />
